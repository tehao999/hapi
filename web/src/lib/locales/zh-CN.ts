export default {
  ...
  'composer.snippets': '短语',
  'composer.snippets.saved': '固定短语',
  'composer.snippets.recent': '最近消息',
  'composer.snippets.add': '添加',
  'composer.snippets.edit': '编辑',
  'composer.snippets.delete': '删除',
  'composer.snippets.emptySlot': '固定短语 {index}',
  'composer.snippets.placeholder': '输入可复用的固定内容…',
  'composer.snippets.loading': '正在加载最近消息…',
  'composer.snippets.noRecent': '暂无最近消息',
  'composer.snippets.loadError': '加载最近消息失败',
  ...
  'composer.codexDesktopSyncReadonly.title': '桌面镜像会话',
  'composer.codexDesktopSyncReadonly.body': '从 HAPI 发送会在桌面执行空闲后接管这条 Codex 线程。',
