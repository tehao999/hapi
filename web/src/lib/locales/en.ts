export default {
  ...
  'composer.snippets.emptySlot': 'Fixed snippet {index}',
  'composer.snippets.placeholder': 'Type a reusable snippet…',
  'composer.snippets.loading': 'Loading recent messages…',
  'composer.snippets.noRecent': 'No recent user messages',
  'composer.snippets.loadError': 'Failed to load recent messages',
